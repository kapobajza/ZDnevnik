<script lang="ts">
  ...
  const buttonVariants = tv({
    base: "zd-flex zd-items-center zd-justify-center zd-rounded-full zd-bg-primary zd-transition-colors hover:zd-border hover:zd-border-primary hover:zd-bg-primary-foreground [&>svg]:hover:zd-text-primary",
    variants: {
      size: {
